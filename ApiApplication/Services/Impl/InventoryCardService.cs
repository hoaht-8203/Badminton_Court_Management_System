...
public class InventoryCardService(ApplicationDbContext context) : IInventoryCardService
{
    ...
    public async Task<UpdateInventoryCardResponse> UpdateInventoryCardAsync(
        UpdateInventoryCardRequest request
    )
    {
    ...
    public async Task<UpdateInventoryCardResponse> CreateInventoryCardForSaleAsync(
    ...
    public async Task<UpdateInventoryCardResponse> CreateInventoryCardForPurchaseAsync(
