...
public class ReceiptsController(IReceiptService receiptService) : ControllerBase
{
    ...
    [HttpGet("list")]
    public async Task<ActionResult<ApiResponse<List<ListReceiptResponse>>>> List([FromQuery] ListReceiptRequest req)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<ApiResponse<object>>> Update(int id, [FromBody] CreateReceiptRequest req)
    {
