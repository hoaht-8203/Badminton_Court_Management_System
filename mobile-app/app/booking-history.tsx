...
import { bookingService, ListUserBookingHistoryResponse } from "../services/bookingService";
...
function BookingCard({
  ...
  return (
    ...
    >
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={{ marginTop: 4 }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center", marginTop: 4 }}>
                ...
                <Text style={{ fontSize: 14, color: subTextColor, marginLeft: 4 }}>
        ...
        >
          <View>
            ...
            <Text style={{ fontSize: 16, fontWeight: "700", color: "#10b981", marginTop: 2 }}>
              {booking.totalAmount ? formatCurrency(booking.totalAmount) : "Chưa tính"}
            </Text>
          </View>
          <View style={{ alignItems: "flex-end" }}>
            <Text style={{ fontSize: 12, color: subTextColor }}>Đã trả</Text>
            <Text style={{ fontSize: 16, fontWeight: "600", color: "#10b981", marginTop: 2 }}>
          ...
          <View style={{ alignItems: "flex-end" }}>
            ...
            <Text
              style={{
                fontSize: 16,
                fontWeight: "600",
                color: booking.remainingAmount && booking.remainingAmount > 0 ? "#f59e0b" : "#10b981",
                marginTop: 2,
              }}
            >
      ...
      {/* Expanded Content */}
      {expanded && (
        <View style={{ borderTopWidth: 1, borderTopColor: cardBorder, padding: 16 }}>
          {/* Tabs */}
          <View
            style={{
              flexDirection: "row",
          ...
          <View style={{ gap: 12 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              <Text style={{ fontSize: 14, color: subTextColor }}>Khách hàng:</Text>
              <Text style={{ fontSize: 14, fontWeight: "600", color: textColor }}>
                {booking.customerName || "N/A"}
              </Text>
            </View>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              <Text style={{ fontSize: 14, color: subTextColor }}>Tổng giờ:</Text>
              <Text style={{ fontSize: 14, fontWeight: "600", color: textColor }}>
                      ...
                      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                        <View style={{ flex: 1 }}>
                          ...
                          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 4 }}>
                            ...
                            <Text style={{ fontSize: 12, color: subTextColor, marginLeft: 4 }}>
                        ...
                        >
                          <Text style={{ fontSize: 11, fontWeight: "600", color: occStatusColor }}>
                            {getStatusText(occurrence.status)}
                          </Text>
                        </View>
                      </View>
                      {occurrence.note && (
                        <Text style={{ fontSize: 12, color: subTextColor, marginTop: 8 }}>
            ...
            <View style={{ marginTop: 16 }}>
              ...
              {allPayments.length === 0 ? (
                <Text style={{ fontSize: 14, color: subTextColor, fontStyle: "italic" }}>
                      ...
                      >
                        <View style={{ flex: 1 }}>
                          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                            <Ionicons name="card-outline" size={16} color={subTextColor} />
                          ...
                          <Text style={{ fontSize: 12, color: subTextColor, marginTop: 4 }}>
                            {payment.paymentCreatedAt
                              ? formatDate(payment.paymentCreatedAt) +
                                " " +
                                new Date(payment.paymentCreatedAt).toLocaleTimeString("vi-VN", {
                                  hour: "2-digit",
                                  minute: "2-digit",
                                })
                              : "N/A"}
                        ...
                        <View style={{ alignItems: "flex-end", gap: 4 }}>
                          ...
                          >
                            <Text style={{ fontSize: 10, fontWeight: "600", color: paymentStatusColor }}>
                              {payment.status === "Paid"
                                ? "Đã thanh toán"
      ...
      >
        {bookings.length === 0 ? (
          <View style={{ flex: 1, justifyContent: "center", alignItems: "center", paddingVertical: 48 }}>
            ...
            <Text style={{ color: subTextColor, marginTop: 16, fontSize: 16, textAlign: "center" }}>
