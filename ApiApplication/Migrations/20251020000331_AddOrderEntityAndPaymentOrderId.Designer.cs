...
namespace ApiApplication.Migrations
{
    ...
    [Migration("20251020000331_AddOrderEntityAndPaymentOrderId")]
    partial class AddOrderEntityAndPaymentOrderId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiApplication.Entities.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 20, 0, 3, 31, 239, DateTimeKind.Utc).AddTicks(1790),
                            CreatedBy = "System",
                            Description = "Ngày tạo bảng lương hàng tháng",
                            Key = "MonthlyPayrollGeneration",
                            UpdatedAt = new DateTime(2025, 10, 20, 0, 3, 31, 239, DateTimeKind.Utc).AddTicks(1790),
                            UpdatedBy = "System",
                            Value = "1"
                        },
                        new
            ...
            modelBuilder.Entity("ApiApplication.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("ApiApplication.Entities.Order", null)
                        .WithMany("Payments")
