    ...
    <div style={{ background: "#fff", padding: 16 }}>
      <Tabs defaultActiveKey="info" items={[
        {
          ...
          children: (
            <Descriptions column={3} size="small" bordered>
              ...
              <Descriptions.Item label="Ghi chú"> <span style={{ color: '#aaa' }}>Ghi chú...</span> </Descriptions.Item>
            </Descriptions>
          ),
        },
        {
        ...
        },
        {
          ...
          children: (
            <div>Lịch sử thanh toán (demo)</div>
          ),
        },
      ]} />
      <div style={{ marginTop: 16, display: "flex", justifyContent: "space-between" }}>
        ...
        <div>
          ...
          <Button icon={<span className="anticon anticon-file-excel" />} style={{ marginLeft: 8 }}>Xuất file</Button>
        </div>
      </div>
    </div>
  );
