...
public class FeedbackService(ApplicationDbContext context, IMapper mapper, ICurrentUser currentUser)
    : IFeedbackService
{
    ...
    public async Task<DetailFeedbackResponse> CreateFeedBackAsync(CreateFeedbackRequest request)
    {
        ...
        {
            throw new ApiException(
                $"BookingCourtOccurrence không tồn tại: {request.BookingCourtOccurrenceId}",
        ...
        if (
            !string.Equals(
                occurrence.Status,
                BookingCourtOccurrenceStatus.Completed,
                StringComparison.Ordinal
            )
        )
        {
            throw new ApiException(
                "Chỉ có thể đánh giá khi lịch đã Completed",
        ...
        if (customer == null)
        {
            ...
            {
                throw new ApiException(
                    "Không xác định được khách hàng của lịch đặt",
                    System.Net.HttpStatusCode.BadRequest
                );
            }
            customer =
                await _context.Customers.FirstOrDefaultAsync(c =>
                    c.Id == occurrence.BookingCourt.CustomerId
                )
                ?? throw new ApiException(
                    "Khách hàng của lịch đặt không tồn tại",
                    System.Net.HttpStatusCode.NotFound
                );
        }
        ...
        {
            throw new ApiException(
                "Khách hàng không sở hữu lịch đặt này",
                System.Net.HttpStatusCode.Forbidden
            );
        }
        ...
        var duplicated = await _context.Feedbacks.AnyAsync(f =>
            ...
            && f.BookingCourtOccurrenceId == request.BookingCourtOccurrenceId
            && f.Status != FeedbackStatus.Deleted
        );
        if (duplicated)
        {
            throw new ApiException(
                "Bạn đã đánh giá lịch này rồi",
                System.Net.HttpStatusCode.BadRequest
            );
        }
        ...
        if (request.CourtQuality is < 1 or > 5)
            throw new ApiException(
                "CourtQuality phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
            );
        if (request.StaffService is < 1 or > 5)
            throw new ApiException(
                "StaffService phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
            );
        if (request.Cleanliness is < 1 or > 5)
            throw new ApiException(
                "Cleanliness phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
            );
        if (request.Lighting is < 1 or > 5)
            throw new ApiException(
                "Lighting phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
            );
        if (request.ValueForMoney is < 1 or > 5)
            throw new ApiException(
                "ValueForMoney phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
            );
    ...
    public async Task<DetailFeedbackResponse> DetailFeedBackAsync(DetailFeedbackRequest request)
    {
        ...
        {
            throw new ApiException(
                $"Feedback không tồn tại: {request.Id}",
                System.Net.HttpStatusCode.NotFound
            );
        }
        return _mapper.Map<DetailFeedbackResponse>(entity);
    ...
    public async Task<DetailFeedbackResponse> UpdateFeedBackAsync(UpdateFeedbackRequest request)
    {
        ...
        {
            throw new ApiException(
                "Feedback đã bị xoá, không thể cập nhật",
                System.Net.HttpStatusCode.BadRequest
            );
        }

        // Ensure related occurrence still valid and Completed
        var occurrence = await _context.BookingCourtOccurrences.FirstOrDefaultAsync(x =>
            x.Id == entity.BookingCourtOccurrenceId
        );
        if (occurrence == null)
        {
            throw new ApiException(
                "BookingCourtOccurrence không tồn tại",
                System.Net.HttpStatusCode.NotFound
            );
        }
        if (
        ...
        {
            throw new ApiException(
                "Chỉ có thể cập nhật đánh giá khi lịch đã Completed",
                System.Net.HttpStatusCode.BadRequest
            );
        }
        ...
        if (request.Rating.HasValue && (request.Rating.Value < 1 || request.Rating.Value > 5))
            throw new ApiException("Rating phải từ 1 đến 5", System.Net.HttpStatusCode.BadRequest);
        if (
            request.CourtQuality.HasValue
            && (request.CourtQuality.Value < 1 || request.CourtQuality.Value > 5)
        )
            throw new ApiException(
                "CourtQuality phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
        ...
        if (
            request.StaffService.HasValue
            && (request.StaffService.Value < 1 || request.StaffService.Value > 5)
        )
            throw new ApiException(
                "StaffService phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
        ...
        if (
            request.Cleanliness.HasValue
            && (request.Cleanliness.Value < 1 || request.Cleanliness.Value > 5)
        )
            throw new ApiException(
                "Cleanliness phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
        ...
        if (
            request.ValueForMoney.HasValue
            && (request.ValueForMoney.Value < 1 || request.ValueForMoney.Value > 5)
        )
            throw new ApiException(
                "ValueForMoney phải từ 1 đến 5",
                System.Net.HttpStatusCode.BadRequest
        ...
        if (
            string.IsNullOrWhiteSpace(originalReply)
            && !string.IsNullOrWhiteSpace(entity.AdminReply)
        )
        {
    ...
    public async Task<List<ListFeedbackResponse>> ListFeedBackByBookingOccurrenceAsync(
    ...
    public async Task<List<ListFeedbackResponse>> ListFeedBackByCustomerAsync(
