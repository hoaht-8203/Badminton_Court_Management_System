...
namespace ApiApplication.Migrations
{
    ...
    [Migration("20251103141055_FixDatabase03112025V2")]
    partial class FixDatabase03112025V2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiApplication.Entities.Payment", b =>
                {
                    ...
                    b.Property<int?>("UserMembershipId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ApiApplication.Entities.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 11, 3, 14, 10, 55, 207, DateTimeKind.Utc).AddTicks(5970),
                            CreatedBy = "System",
                            Description = "Ngày tạo bảng lương hàng tháng",
                            Key = "MonthlyPayrollGeneration",
                            UpdatedAt = new DateTime(2025, 11, 3, 14, 10, 55, 207, DateTimeKind.Utc).AddTicks(5970),
                            UpdatedBy = "System",
                            Value = "1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 11, 3, 14, 10, 55, 207, DateTimeKind.Utc).AddTicks(5980),
                            CreatedBy = "System",
                            Description = "Chế độ nghỉ lễ của hệ thống",
                            Key = "Holidays",
                            UpdatedAt = new DateTime(2025, 11, 3, 14, 10, 55, 207, DateTimeKind.Utc).AddTicks(5980),
                            UpdatedBy = "System",
                            Value = ""
                        });
                });
            ...
            modelBuilder.Entity("ApiApplication.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("ApiApplication.Entities.UserMembership", null)
                        .WithMany("Payments")
                        .HasForeignKey("UserMembershipId1");
