...
public class DashboardController(IDashboardService dashboardService) : ControllerBase
{
    ...
    [HttpGet("summary")]
    public async Task<ApiResponse<DashboardSummaryResponse>> Summary([FromQuery] DateTime? from, [FromQuery] DateTime? to, [FromQuery] int? branchId)
    {
    ...
    [HttpGet("revenue")]
    public async Task<ApiResponse<RevenuePointDto[]>> Revenue([FromQuery] DateTime? from, [FromQuery] DateTime? to, [FromQuery] string granularity = "day", [FromQuery] int? branchId = null)
    {
    ...
    public async Task<ApiResponse<HeatmapCellDto[]>> Heatmap([FromQuery] DateTime? from, [FromQuery] DateTime? to, [FromQuery] int? branchId = null)
    {
    ...
    [HttpGet("top-courts")]
    public async Task<ApiResponse<TopCourtDto[]>> TopCourts([FromQuery] DateTime? from, [FromQuery] DateTime? to, [FromQuery] int limit = 10, [FromQuery] int? branchId = null)
    {
    ...
    public async Task<ApiResponse<RecentTransactionDto[]>> RecentTransactions([FromQuery] DateTime? from, [FromQuery] DateTime? to, [FromQuery] int limit = 20, [FromQuery] int? branchId = null)
    {
