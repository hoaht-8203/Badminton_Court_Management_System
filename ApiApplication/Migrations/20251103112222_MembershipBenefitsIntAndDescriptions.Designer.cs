...
namespace ApiApplication.Migrations
{
    ...
    [Migration("20251103112222_MembershipBenefitsIntAndDescriptions")]
    partial class MembershipBenefitsIntAndDescriptions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiApplication.Entities.Membership", b =>
                {
                    ...
                    b.Property<Dictionary<string, int>>("Benefits")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Benefits = new Dictionary<string, int> { ["discount_court"] = 5, ["discount_service"] = 10, ["discount_product"] = 15 },
                            BenefitsDescription = new[] { "Ưu đãi 5% khi đặt sân", "Ưu đãi 10% khi sử dụng dịch vụ", "Ưu đãi 15% khi mua sản phẩm" },
                        ...
                        {
                            Id = 2,
                            Benefits = new Dictionary<string, int> { ["discount_court"] = 10, ["discount_service"] = 20, ["discount_product"] = 25 },
                            BenefitsDescription = new[] { "Ưu đãi 10% khi đặt sân", "Ưu đãi 20% khi sử dụng dịch vụ", "Ưu đãi 25% khi mua sản phẩm" },
                            CreatedAt = new DateTime(2025, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatedBy = "System",
                        ...
                        {
                            Id = 3,
                            Benefits = new Dictionary<string, int> { ["discount_court"] = 15, ["discount_product"] = 25 },
                            BenefitsDescription = new[] { "Ưu đãi 15% khi đặt sân", "Miễn phí sử dụng dịch vụ", "Miễn phí nước giải khát", "Ưu đãi 25% khi mua sản phẩm" },
                            CreatedAt = new DateTime(2025, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatedBy = "System",
            ...
            modelBuilder.Entity("ApiApplication.Entities.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 11, 3, 11, 22, 22, 640, DateTimeKind.Utc).AddTicks(7160),
                            CreatedBy = "System",
                            Description = "Ngày tạo bảng lương hàng tháng",
                            Key = "MonthlyPayrollGeneration",
                            UpdatedAt = new DateTime(2025, 11, 3, 11, 22, 22, 640, DateTimeKind.Utc).AddTicks(7160),
                            UpdatedBy = "System",
                            Value = "1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 11, 3, 11, 22, 22, 640, DateTimeKind.Utc).AddTicks(7170),
                            CreatedBy = "System",
                            Description = "Chế độ nghỉ lễ của hệ thống",
                            Key = "Holidays",
                            UpdatedAt = new DateTime(2025, 11, 3, 11, 22, 22, 640, DateTimeKind.Utc).AddTicks(7170),
                            UpdatedBy = "System",
                            Value = ""
                        });
                });
