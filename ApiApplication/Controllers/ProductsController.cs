...
namespace ApiApplication.Controllers
{
    ...
    public class ProductsController(IProductService productService) : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<ActionResult<ApiResponse<List<ListProductResponse>>>> List([FromQuery] ListProductRequest request)
        {
            var result = await _productService.ListAsync(request);
            return Ok(ApiResponse<List<ListProductResponse>>.SuccessResponse(result, "Lấy danh sách sản phẩm thành công"));
        }

        [HttpGet("detail")]
        public async Task<ActionResult<ApiResponse<DetailProductResponse>>> Detail([FromQuery] DetailProductRequest request)
        {
            var result = await _productService.DetailAsync(request.Id);
            return Ok(ApiResponse<DetailProductResponse>.SuccessResponse(result, "Lấy chi tiết sản phẩm thành công"));
        }
        ...
        [HttpPut("update")]
        public async Task<ActionResult<ApiResponse<object?>>> Update([FromBody] UpdateProductRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<object?>>> UpdateImages([FromForm] UpdateProductImagesRequest request)
        {
            await _productService.UpdateImagesAsync(request);
            return Ok(ApiResponse<object?>.SuccessResponse(null, "Cập nhật hình ảnh sản phẩm thành công"));
        }
    }
} 