...
public class StockOutsController(IStockOutService stockOutService) : ControllerBase
{
    ...
    [HttpGet("list")]
    public async Task<ActionResult<ApiResponse<List<ListStockOutResponse>>>> List([FromQuery] ListStockOutRequest req)
    {
        var result = await _stockOutService.ListAsync(req.From, req.To, req.Status);
        return Ok(ApiResponse<List<ListStockOutResponse>>.SuccessResponse(result, "Lấy danh sách xuất kho thành công"));
    }
    ...
    public async Task<ActionResult<ApiResponse<DetailStockOutResponse>>> Detail(int id)
    {
        ...
        return Ok(ApiResponse<DetailStockOutResponse>.SuccessResponse(result, "Lấy chi tiết xuất kho thành công"));
    }

    [HttpPost("create")]
    public async Task<ActionResult<ApiResponse<int>>> Create([FromBody] CreateStockOutRequest request)
    {
    ...
    [HttpPut("update/{id}")]
    public async Task<ActionResult<ApiResponse<object?>>> Update(int id, [FromBody] CreateStockOutRequest request)
    {
    ...
    public async Task<ActionResult<ApiResponse<object?>>> Complete(int id)
    {
        ...
        return Ok(ApiResponse<object?>.SuccessResponse(null, "Hoàn thành phiếu xuất kho thành công"));
    }
