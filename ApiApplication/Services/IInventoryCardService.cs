...
public interface IInventoryCardService
{
    ...
    Task<UpdateInventoryCardResponse> CreateInventoryCardForSaleAsync(CreateInventoryCardForSaleRequest request);
    Task<UpdateInventoryCardResponse> CreateInventoryCardForPurchaseAsync(CreateInventoryCardForPurchaseRequest request);
}
