    ...
    >
      <Form form={form} onFinish={handleSubmit} layout="vertical">
        <Row gutter={16}>
          ...
          <Col span={12}>
            <FormItem<UpdateUserRequest> name="fullName" label="Họ và tên" rules={[{ required: true, message: "Họ và tên là bắt buộc" }]}>
              <Input placeholder="Nhập họ và tên" />
            </FormItem>
          </Col>
          <Col span={12}>
            <FormItem<UpdateUserRequest> name="phoneNumber" label="Số điện thoại" rules={[{ required: true, message: "Số điện thoại là bắt buộc" }]}>
