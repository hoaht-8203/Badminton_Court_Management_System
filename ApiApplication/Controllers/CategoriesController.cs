...
public class CategoriesController(ICategoryService categoryService) : ControllerBase
{
    ...
    [HttpGet("list")]
    public async Task<ApiResponse<ListCategoryResponse[]>> List([FromQuery] ListCategoryRequest request)
    {
    ...
    [HttpGet("detail")]
    public async Task<ApiResponse<DetailCategoryResponse>> Detail([FromQuery] DetailCategoryRequest request)
    {
