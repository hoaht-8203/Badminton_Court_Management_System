...
{
    /// <inheritdoc />
    public partial class FixDatabaseAfterMergeV1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CancelledShifts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CancelledShifts_Shifts_ShiftId",
                        column: x => x.ShiftId,
                        principalTable: "Shifts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CancelledShifts_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CancelledShifts_ShiftId",
                table: "CancelledShifts",
                column: "ShiftId");

            migrationBuilder.CreateIndex(
                name: "IX_CancelledShifts_StaffId",
                table: "CancelledShifts",
                column: "StaffId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "CreatedAt", "UpdatedAt" },
                values: new object[] { new DateTime(2025, 9, 22, 9, 27, 22, 729, DateTimeKind.Utc).AddTicks(5299), new DateTime(2025, 9, 22, 9, 27, 22, 729, DateTimeKind.Utc).AddTicks(5301) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "CreatedAt", "UpdatedAt" },
                values: new object[] { new DateTime(2025, 9, 22, 9, 27, 22, 729, DateTimeKind.Utc).AddTicks(5307), new DateTime(2025, 9, 22, 9, 27, 22, 729, DateTimeKind.Utc).AddTicks(5308) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "CreatedAt", "UpdatedAt" },
                values: new object[] { new DateTime(2025, 9, 22, 9, 27, 22, 729, DateTimeKind.Utc).AddTicks(5311), new DateTime(2025, 9, 22, 9, 27, 22, 729, DateTimeKind.Utc).AddTicks(5311) });
        }
    }
}
